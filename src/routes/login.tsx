...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      { title: "Connexion — Kaayu Workspace" },
      { name: "description", content: "Connectez-vous à votre espace de travail Kaayu." },
    ],
  }),
  component: LoginPage,
});
      ...
      <div className="hidden flex-col justify-between bg-sidebar p-12 text-sidebar-foreground lg:flex">
        ...
        <div className="space-y-4">
          ...
          <p className="max-w-md text-sm text-sidebar-foreground/70">
            Documents, réunions, tâches, calendrier, OCR et assistant IA — tout dans une interface
            unifiée, en français, sur tous vos appareils.
          </p>
        </div>
        <div className="text-xs text-sidebar-foreground/50">
          © {new Date().getFullYear()} Kaayu Workspace
        </div>
      </div>
      ...
      <div className="flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {mode === "login" ? "Accédez à votre espace" : "Démarrez en quelques secondes"}
          </p>
